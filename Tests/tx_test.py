...
def test_cff2_no_vf_bug353():
    # read CFF2 WITHOUT VF info, write a CFF2 out.
    # regular_CFF2.otf is derived by taking the regular.otf file from
    # the sfntdiff 'input_data' directory, and converting the CFF table to CFF2.
